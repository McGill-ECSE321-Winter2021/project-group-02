...
public class Login_Signup extends Fragment
{
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState)
    {
        ...
        view.findViewById(R.id.button_login).setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                NavHostFragment.findNavController(Login_Signup.this).navigate(R.id.action_login_Signup_to_login);
            }
        });
        ...
        view.findViewById(R.id.button_signup).setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                NavHostFragment.findNavController(Login_Signup.this).navigate(R.id.action_login_Signup_to_signup);
            }
        });
        ...
        view.findViewById(R.id.button_back1).setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                NavHostFragment.findNavController(Login_Signup.this).navigate(R.id.action_login_Signup_to_mainpage);
            }
        });
    }
}
