<template>
	<div class="view-booked-appointments-assistant">
		...
		<div id="appointment-containter" v-if="this.enteredValue == true">
			<div class="myaccount-spacer"></div>
			<div class="list-or-not-appointments" v-if="appointments.length === 0">
				<p>No appointments</p>
			</div>
			<div
				class="appointment"
			...
			>
				<label
					...
					>Appointment Time: {{ timeslots.startDate }}
				</label>
				<label
					class="form-text"
					v-if="timeslots.startDate !== timeslots.endDate"
					>Appointment Time: {{ timeslots.startDate }}-{{ timeslots.endDate }}
				</label>
				<br />
				<label class="form-text"
					>From {{ timeslots.startTime }} to {{ timeslots.endTime }}</label
				><br />
				<label class="form-text"
					>Appointment Type:
