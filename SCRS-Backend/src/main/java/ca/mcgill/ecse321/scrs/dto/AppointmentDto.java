...
public class AppointmentDto
{
    ...
    public AppointmentDto(int id, AppointmentType type, String note, CustomerDto customer, List<TimeslotDto> timeslotList)
    {
        this(id, type, null, note, -1, null, false, customer, timeslotList);
    }
